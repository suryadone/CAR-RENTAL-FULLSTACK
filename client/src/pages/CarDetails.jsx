    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
         ...
         className='lg:col-span-2'>
            ...
            src={car.image} alt="" className='w-full h-auto md:max-h-100
          ...
          text-gray-500'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                type="date" className='border-borderColor px-3 py-2
              ...
              <div className='flex flex-col gap-2'>
                ...
                <input value={returnDate} onChange={(e)=> setReturnDate(e.target.value)} type="date" className='border-borderColor px-3 py-2
